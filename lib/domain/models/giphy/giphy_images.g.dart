...
GiphyImagesModel _$GiphyImagesModelFromJson(Map<String, dynamic> json) =>
    GiphyImagesModel(
      ...
      images: json['images'] == null
          ? null
          : GiphyImageDetailModel.fromJson(
              json['images'] as Map<String, dynamic>),
      user: json['user'],
    );

Map<String, dynamic> _$GiphyImagesModelToJson(GiphyImagesModel instance) =>
    <String, dynamic>{
      'type': instance.type,
      'id': instance.id,
      'url': instance.url,
